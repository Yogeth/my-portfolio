...
export default function Projects() {
  ...
  return (
    <div className="p-3 xl:p-10">
      <p
        className="font-bold text-xl tracking-widest md:text-2xl"
        style={{ color: color.textPrimary }}
      >
        {ProjectsPageData.intro}
      </p>

      <h1
        className="text-lg pt-3 md:text-xl xl:tracking-wider"
        style={{ color: color.textSecondary }}
      >
        {ProjectsPageData.heading}
      </h1>
      ...
      <section className="grid grid-cols-1 p-1 gap-7 lg:grid-cols-2 xl:p-3 xl:grid-cols-[repeat(auto-fit,minmax(auto,auto))]">
        {ProjectsPageData.showcase
          ...
          .map((element, i) => (
            <div
              key={i}
              className="p-6 bg-[rgba(172,167,166,0.1)]
            ...
            >
              ...
              <p
                className=" text-lg font-medium font-inter pt-5 tracking-wide md:text-xl"
                style={{ color: color.textSecondary }}
              >
                {element.para}
              </p>
              ...
              <ul className="flex flex-wrap gap-2 pt-3 w-fit">
                {element.tech.map((el, i) => (
                  ...
                  justify-center items-center flex-row rounded-sm text-xs p-2 md:p-3 md:text-sm"
                    key={i}
                    style={{ color: color.accent }}
                  >
                    {el}
      ...
      <div className=" xl:w-[1536px] xl:grid xl:justify-start xl:pt-7 xl:p-3">
        ...
        >
          ...
          <p
            className="font-medium font-jetbrains text-lg tracking-wide md:text-2xl md:tracking-normal"
            style={{ color: color.textSecondary }}
          >
          ...
          <Link to="/contact" className="">
            <button
              className="text-shadow-xs  font-semibold font-inter rounded-2xl p-4 md:px-8"
              style={{
