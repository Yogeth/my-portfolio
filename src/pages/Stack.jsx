                ...
                <div key={i}>
                  <section className="">
                    <p className="flex justify-between md:text-lg">
                      <span className=" font-medium font-inter" style={{color:color.textSecondary}}>
                        {element.txt}
                      </span>
                      <span className="font-medium font-inter" style={{color:color.accent}}>
                        {element.percent}
                      </span>
                    </p>

                    <button className="border h-2 w-full p-[2px] rounded-xl" style={{borderColor:color.textPrimary}}>
                      <div className="h-full rounded-xl btn-span" 
                      style={{"--width-percent":element.percent,backgroundColor:color.textSecondary}}
                      ></div>
                    </button>
                  </section>
                </div>
